    ...
    $.fn.hovercard = function (options) {
        ...
        return this.each(function () {
            ...
            obj.closest(".hc-preview").hover(function () {
                ...
                $this.css("zIndex", "6");
                obj.css("zIndex", "6").find('.hc-details').css("zIndex", "50");
                ...
                //Undo the z indices
                $this = $(this);
                if(obj.parents(".post-body").length){
                    ...
                    case "custom":
                        {
                            ...
                            cardHTML = function (profileData) {
                                return '<div class="s-card s-card-pad">' +
                                        (profileData.profile ? ('<img class="s-img" src=' + profileData.profile + ' />') : '') +
                                        (profileData.name ? ('<a href="'+profileData.link+'" class="s-name">' + profileData.name + ' </a><br/>') : '') +
                                        '</div>';
                            };
                            loadingHTML = "Loading...";

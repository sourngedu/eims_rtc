...
!(function(a) {
    ...
    (b.prototype = {
        ...
        save: function(b) {
            ...
            return e
                ? (this.showLoading(),
                  (c = { key: this.options.key || "", value: b, pk: d }),
        ...
        (a.fn.editableform.template =
            '<form class="form-inline editableform" url>\
    ...
    (function(a) {
        ...
        a.extend(a.fn.editableform.Constructor.prototype, {
            ...
            (a.fn.editableform.buttons =
                '<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="fas fa-check" aria-hidden="true"></i></button><button type="button" class="btn btn-default btn-sm editable-cancel"><i class="fas fa-times" aria-hidden="true"></i></button>'),
            (a.fn.editableform.errorGroupClass = "has-errors"),

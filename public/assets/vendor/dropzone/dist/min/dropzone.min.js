...
var _createClass = (function() {
  ...
  Dropzone = (function(a) {
    function b(a, c) {
      ...
      if (d.element.dropzone)  return d.element.dropzone;//throw new Error("Dropzone already attached.");
              ...
              if (
                ...
                !(function c() {
                  return (
                    ...
                    (a.hiddenFileInput.name = a.options.paramName),
                    ...
                    a.hiddenFileInput.addEventListener("change", function(event) {

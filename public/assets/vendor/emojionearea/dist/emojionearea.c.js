...
(function(factory, global) {
    ...
    var getDefaultOptions = function() {
        return $.fn.emojioneArea && $.fn.emojioneArea.defaults
            ? $.fn.emojioneArea.defaults
            : {
                  attributes: {
                      dir: "ltr",
                      spellcheck: false,
            ...
            app = div(
                ...
                (picker = self.picker = div(
                    ...
                    div(
                        ...
                        (tones = div("tones", function() {
                            if (options.tones) {
                                this.addClass(
                                    selector(
                                        "tones-" + options.tonesStyle,
                                        true
                                    )
                                );
                                for (var i = 0; i <= 5; i++) {
        ...
        $.each(options.filters, function(filter, params) {
            ...
            do {
                var category = div("category")
                        .attr({ name: filter, "data-tone": skin })
                        .appendTo(emojisList),
        ...
        self.on("@filter.click", function(filter) {
            ...
            .on("@!paste", function(editor, event) {
                ...
                if (event.originalEvent.clipboardData) {
                    var text = event.originalEvent.clipboardData.getData(
                        "text/plain"
                    );
                    pasteText(text);
            ...
            if (!emojione || getSupportMode(detectVersion(emojione)) < 2) {
                ...
                $.getScript(
                    ...
                    function() {
                        ...
                        if (options.sprite) {
                            var sprite =
                                cdn.base + "/sprites/emojione.sprites.css";
                    ...
                    if (eventStorage[id][event] && !/^@/.test(event)) {
                        if (handler) {
                            $.each(eventStorage[id][event], function(j, fn) {
                                if (fn === handler) {
                                    eventStorage[id][event] = eventStorage[id][
                                        event
                                    ].splice(j, 1);
                                }
                            });

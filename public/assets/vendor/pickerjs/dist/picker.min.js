...
!(function(e, t) {
    ...
    var Z = /\s\s*/,
        G = (function() {
            ...
            if (s) {
                ...
                g.addEventListener("test", n, i),
                    g.removeEventListener("test", n, i);
            }
            return e;
        })();
    function Q(n, e, i) {
    ...
    var ae = {
        ...
        oe = {
            ...
            current: function(e, t) {
                ...
                switch (r.charAt(0)) {
                    ...
                    case "S":
                        return (
                            T(t) && n.setMilliseconds(t), n.getMilliseconds()
                        );
                }
                return n;
            },
        ...
        ce = {
            ...
            setDate: function(e) {
                return (
                    e && ((this.date = this.parseDate(e)), this.render()), this
                );
            },
            update: function() {
                return (
                        ...
                        value: function() {
                            ...
                            if (!$(e, b)) {
                                ...
                                var r = i.getElementsByClassName(b)[0],
                                    u = r.getElementsByClassName(
                                        "".concat(b, "-grid")
                                    )[0],
                                    a = h.container;
                                if (
                                    (F(a) && (a = document.querySelector(a)), n)
                                )
                                    J(r, w), J(r, M), a || (a = e);
                                else {
                                    ...
                                    (this.body = o),
                                        ...
                                        (this.initialBodyPaddingRight = g.getComputedStyle(
                                            o
                                        ).paddingRight),
                                        J(r, "".concat(b, "-fixed")),
                                        a || (a = document.body);
                                ...
                                m % 2 || (m += 1),
                                    ...
                                    h.controls &&
                                        J(u, "".concat(b, "-controls"));
                                var f = h.headers,
                                    p = h.increment;
                                f &&
                                    (J(u, "".concat(b, "-headers")),
                                    (f = B(f) ? f : h.text)),
                                    B(p) ||
                                        (p = {
                                            year: p,

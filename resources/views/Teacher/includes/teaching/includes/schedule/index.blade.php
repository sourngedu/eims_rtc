<div class="row">
    <div class="col">
        ...
        <div class="card">
            @include(config("pages.parent").".includes.teaching.includes.schedule.includes.header")
            @include(config("pages.parent").".includes.teaching.includes.schedule.includes.body")
            @include(config("pages.parent").".includes.teaching.includes.schedule.includes.footer")
        </div>
        @endforeach
        @else
        <div class="card">

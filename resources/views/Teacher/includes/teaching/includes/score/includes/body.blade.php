...
<div class="card-body py-0">
    <div class="table-responsive" data-toggle="list" data-list-values='["id", "name"]'>
        <table class="table table-bordered table-hover table-xs" id="t1 list-table">
            @include(config("pages.parent").".includes.teaching.includes.score.includes.subbody.a")
            @include(config("pages.parent").".includes.teaching.includes.score.includes.subbody.b")
        </table>
    </div>
</div>

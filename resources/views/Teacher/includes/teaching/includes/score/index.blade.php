...
<div class="row">
    <div class="col">
        <div class="card">
            @include(config("pages.parent").".includes.teaching.includes.score.includes.header")
            @include(config("pages.parent").".includes.teaching.includes.score.includes.body")
            @include(config("pages.parent").".includes.teaching.includes.score.includes.footer")
        </div>
    </div>
</div>

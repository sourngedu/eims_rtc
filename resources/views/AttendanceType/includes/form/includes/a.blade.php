                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        <label class="form-control-label" for="name">
                            {{ Translator:: phrase("attendance_type") }}
                        ...
                        <input type="text" class="form-control" name="name" id="name"
                            placeholder="{{ Translator::phrase("attendance_type") }}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-control-label" for="{{$lang["code_name"]}}">
                            {{ Translator:: phrase("attendance_type.as.".$lang["translate_name"]) }}
                        ...
                        <input type="text" class="form-control" name="{{$lang["code_name"]}}"
                            id="{{$lang["code_name"]}}"
                            placeholder="{{ Translator::phrase("attendance_type.as.".$lang["translate_name"]) }}"
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        <label class="form-control-label" for="credit_absent">
                            {{ Translator:: phrase('credit_absent') }}
                        ...
                        <input type="number" step="any" class="form-control" name="credit_absent" id="credit_absent"
                            placeholder="{{ Translator::phrase('credit_absent') }}"

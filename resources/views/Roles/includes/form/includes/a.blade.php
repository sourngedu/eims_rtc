                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="name"
                            placeholder="{{ Translator::phrase("role_name") }}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-control-label" for="{{$lang["code_name"]}}">
                            {{ Translator:: phrase("role.as.".$lang["translate_name"]) }}
                        ...
                        <input type="text" class="form-control" name="{{$lang["code_name"]}}"
                            id="{{$lang["code_name"]}}"
                            placeholder="{{ Translator::phrase("role.as.".$lang["translate_name"]) }}"
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="view_path" id="view_path"
                            placeholder="{{ Translator::phrase("view_path") }}"
